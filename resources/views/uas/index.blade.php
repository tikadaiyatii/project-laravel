...
<head>
    ...
    <style>
        ...
        * {
        ...
        #tab-daftar:checked ~ .main-container #isi-daftar,
...
<body>
    ...
    <input type="radio" name="nav" id="tab-daftar">
    ...
    <div class="main-container">
        <nav>
            ...
            <label for="tab-daftar">Daftar</label>
...
<div id="isi-daftar" class="tab-content">
...
<div style="text-align:right; margin-bottom:15px;">
    ...
    <a href="{{ url('/create') }}" class="btn-tambah">
...
<tr>
    ...
    <td>
        ...
        <a href="{{ url('/edit/'.$d->id) }}" class="btn-edit">
            ✏ Edit
        </a>
